  ...
  return (
    <div className={"flex flex-col justify-center items-center  h-screen bg-gradient-to-br gap-1 from-cyan-300 to-sky-600"}>
      ...
      <div className="px-7 py-4 shadow bg-white rounded-md flex flex-col gap-2">
        <input type="text" placeholder="User Name" onChange={(e) => (userName.current = e.target.value)} />
        <input type="password" placeholder="Password" onChange={(e) => (pass.current = e.target.value)} />
